" Based on https://github.com/ajh17/Spacegray.vim
...
set background=dark
let g:colors_name = 'spaceterm'

if !exists('g:terminal_bg')
  let g:terminal_bg = 0
endif
...
hi Statement       ctermbg=NONE ctermfg=13     guibg=NONE     guifg=#af3a03  cterm=NONE      gui=NONE
...
hi ColorColumn     ctermbg=235  ctermfg=NONE   guibg=#303030  guifg=NONE     cterm=NONE      gui=NONE
hi SignColumn      ctermbg=233  ctermfg=250    guibg=#000000   guifg=#B3B8C4  cterm=NONE      gui=NONE
